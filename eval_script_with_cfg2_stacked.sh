...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-1.25-0.5-50 -- bash eval_script_with_cfg_stacked.sh 1.25 0.5 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-1.25-0.75-50 -- bash eval_script_with_cfg_stacked.sh 1.25 0.75 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-1.25-1.0-50 -- bash eval_script_with_cfg_stacked.sh 1.25 1.0 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-1.75-0.5-50 -- bash eval_script_with_cfg_stacked.sh 1.75 0.5 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-1.75-0.75-50 -- bash eval_script_with_cfg_stacked.sh 1.75 0.75 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-1.75-1.0-50 -- bash eval_script_with_cfg_stacked.sh 1.75 1.0 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-2.25-0.5-50 -- bash eval_script_with_cfg_stacked.sh 2.25 0.5 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-2.25-0.75-50 -- bash eval_script_with_cfg_stacked.sh 2.25 0.75 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-2.25-1.0-50 -- bash eval_script_with_cfg_stacked.sh 2.25 1.0 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-1.75-0.65-50 -- bash eval_script_with_cfg_stacked.sh 1.75 0.65 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-1.75-0.7-50 -- bash eval_script_with_cfg_stacked.sh 1.75 0.7 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-ODE-Ours-Heun-cfg-1.8-0.65-50 -- bash eval_script_with_cfg_stacked.sh 1.8 0.65 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-1.8-0.7-50 -- bash eval_script_with_cfg_stacked.sh 1.8 0.7 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-1.8-0.75-50 -- bash eval_script_with_cfg_stacked.sh 1.8 0.75 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-1.85-0.65-50 -- bash eval_script_with_cfg_stacked.sh 1.85 0.65 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-1.85-0.7-50 -- bash eval_script_with_cfg_stacked.sh 1.85 0.7 50
...
gantry run $args --workspace ai2/structured_diffusion --cluster ai2/jupiter-cirrascale-2 --cluster ai2/saturn-cirrascale --gpus 8 --name SiTXL2-StackedCFG-Ours-cfg-1.85-0.75-50 -- bash eval_script_with_cfg_stacked.sh 1.85 0.75 50
