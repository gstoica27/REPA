...
def main(args):
    ...
    for _ in pbar:
        ...
        print("The Classes Sampled Are: ", y)
        ...
        with torch.no_grad():
            ...
            for i, (sample, sample_class) in enumerate(zip(samples, y)):
                index = i * dist.get_world_size() + rank + total
                Image.fromarray(sample).save(f"{sample_folder_dir}/{sample_class}_{index:06d}.png")
