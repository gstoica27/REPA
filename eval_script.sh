...
for exp_name in "repaLinear-0p5-sitxl2-dinov2VitB-enc8-bs256-tripsameTemp0p1" "linear-dinov2-b-enc8" "repaLinear-0p5-sitxl2-dinov2VitB-enc8-bs256-tripsameTemp0p05" "repaLinear-0p5-sitxl2-dinov2VitB-enc8-bs256-tripanyTemp0p05"
do
...
for exp_name in "repaLinear-0p5-sitxl2-dinov2VitB-enc8-bs256-tripsameTemp0p1" "repaLinear-0p5-sitxl2-dinov2VitB-enc8-bs256-tripsameTemp0p05" "repaLinear-0p5-sitxl2-dinov2VitB-enc8-bs256-tripanyTemp0p05"
do
    # EXP_LOC="exps/${exp_name}"
    EXP_LOC="/weka/prior-default/georges/research/REPA/exps/${exp_name}"
